// Runnable proof-of-life for the Agent402 OpenAI Agents SDK adapter.
//
// What this proves:
...
//
// Same specs wire into the real OpenAI Agents SDK via agent402Tools() — just
// install `@openai/agents` and `zod` as peer dependencies. See "Using with the
// real Agents SDK" in README.md.
...
console.log("PASS — OpenAI Agents SDK adapter round trip works end-to-end.");
