// Runnable proof-of-life for the Agent402 LangChain.js adapter.
//
// What this proves:
...
//
// Same specs wire into real LangChain.js via agent402Tools() — just install
// `@langchain/core` and `zod` as peer dependencies. See "Using with real
// LangChain" in README.md.
...
console.log("PASS — LangChain adapter round trip works end-to-end.");
