...
Four MCP tools that cover all 1,338 underlying Agent402 tools:
...
live data, crypto reads) cost $0.001–$0.02 in USDC on Base (or Solana/Polygon/Arbitrum — plus USDG on Robinhood Chain); see
