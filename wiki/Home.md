...
| [[Tool Catalog]] | What the 1,355 tools are and how agents discover them |
...
- **An agent developer:** one x402-wrapped fetch (or one MCP server) buys browser rendering, live search, PDFs, durable memory, ~1,000 utilities, and 46 curated multi-tool workflows ([[Skill Packs|Skill-Packs]]) at $0.001–$0.02/call, deterministic, no LLM in the serving path.
