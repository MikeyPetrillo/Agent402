...
export const PACK_STEPS = {
  ...
  // ──────────────────────────────────────────────────────────────────────
  // TODOs (36 packs). Each entry below is auto-generated by getStepConfig
  // when missing from PACK_STEPS. To wire one, add an entry here matching
  // the slug, with mapInput functions for each step. Reference the pack's
  // workflow narrative in src/skills.js for the intended recipe.
  //
  ...
  //
  // Light tier (pure-CPU, PoW-eligible — fill these in last; lower revenue):
  //   text-hygiene  decode-blob  csv-profile  meeting-scheduler  jwt-forensics
  //   user-onboarding  data-interchange  rag-prep  webhook-debug  a11y-audit
  //   trip-planner  identity-mint  loan-comparison  investment-decision
  //   retirement-planning  savings-goal
  // ──────────────────────────────────────────────────────────────────────
};
