...
<div class="wrap">
  ...
  <div class="callout">🚧 <b>The other side of x402: charge AI bots crawling <em>your</em> site.</b> <a href="https://github.com/MikeyPetrillo/Agent402/tree/main/tollbooth" rel="noopener">agent402-tollbooth</a> is an open-source, self-hostable <b>pay-per-crawl</b> gate — humans browse free, AI crawlers pay per request (USDC via x402, or free via proof-of-work). The open answer to Cloudflare pay-per-crawl: no CDN, no Stripe, no signup.</div>
...
curl -i -X POST ${baseUrl}/api/extract \\
  ...
  <footer>
    ...
    Free: <a href="/guides">/guides</a> · <a href="/faq">/faq</a> · <a href="/tools">/tools</a> · <a href="/api/pricing">/api/pricing</a> · <a href="/openapi.json">/openapi.json</a> · <a href="/llms.txt">/llms.txt</a> · <code>GET /health</code>.
