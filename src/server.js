...
app.get("/api/pricing", (_req, res) => {
  ...
  return res.json({
    name: "Agent402.Tools",
    description: `Pay-per-call tools for AI agents via the x402 payment protocol — ${endpointCount} deterministic tools (browser, search, PDFs, OCR, finance, EDGAR, crypto, macro, memory) plus ${SKILL_PACKS.length} curated multi-tool skill packs callable as MCP prompts. Free via in-process proof-of-work or pay per call in USDC on Base, Solana, Polygon, or Arbitrum — plus USDG on Robinhood Chain. Open-source and self-hostable. MCP connector: ${BASE_URL}/mcp.`,
