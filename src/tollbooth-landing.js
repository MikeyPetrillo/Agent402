...
export function tollboothLandingPage(baseUrl) {
  ...
  const description = "agent402-tollbooth is an open-source, self-hostable pay-per-crawl gate. Drop it in front of any Node site (Express, Next.js, Cloudflare Worker, Docker) and AI crawlers pay USDC on Base — or burn CPU — to read your content. Humans browse free.";
